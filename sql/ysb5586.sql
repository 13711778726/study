...
Source Database       : ysb5586

Target Server Type    : MYSQL
Target Server Version : 50615
File Encoding         : 65001

Date: 2015-11-06 17:10:34
*/
...
INSERT INTO `acct` VALUES ('86', '云商宝', '38e9B5X4Sr+fgN9XLwNzAnKI2ivTdbrmtDk7JWoa2evHE+Af', '0', '0', '1', '1', '1446800942', 'hcardView,haddCard,htransferCard,hcardDelete,hcardEn,haddExport,userRecord,hcardRecord,webcallback,cardView,addCard,transferCard,cardDelete,cardEn,addExport,cardrecord,feereport,integralreport,downreport,agentView,agentAdd,agentPay,agentPrivilege,agentEdit,agentDelete,agentEn,userView,addUser,userEdit,userPay,userEn,product_view,product_add,recommendation_view,recommendation_add,reservation_view,service_view,service_add,Brandstory_view,Brandstory_add,news_view,news_add,Contactus_view,Message_view,Freegrab_view,Freegrab_add,Productmg_view,Recruitment_view,Recruitment_add,Business_view,Business_add,Cooperation_view,Cooperation_add,Interaction_view,Interaction_add,location_view,location_add,prelation_view,prelation_add,plu_view,plu_add,disclaimer_view,help_view,syslogView,warnLogView,userIntegralLog,acctIntegralLog', 'all', '101', '201', '1', '1', '1', '0', '0', '0', '0');
...
INSERT INTO `admin_action` VALUES ('192', '7', 'acctIntegralLog', '1');
...
CREATE TABLE `syslog` (
  ...
  PRIMARY KEY (`id`),
  KEY `agent_id` (`agent_id`)
) ENGINE=MyISAM AUTO_INCREMENT=2751 DEFAULT CHARSET=utf8;
...
INSERT INTO `syslog` VALUES ('2749', 'all', '1', '183.5.239.97', '删除代理商 微话电讯', '1446800926');
INSERT INTO `syslog` VALUES ('2750', 'all', '1', '183.5.239.97', '添加代理商 云商宝', '1446800942');
